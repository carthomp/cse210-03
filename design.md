Director (start the game, do the game loop, end it if it's over, call other classes/methods to do things, ask if they want to play again with a new word) [PARENT]
    Attributes:
    keep_playing (bool)
    play_again (string)
